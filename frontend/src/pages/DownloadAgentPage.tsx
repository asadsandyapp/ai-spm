      ...
      <div className="card overflow-hidden">
        <div className="border-b border-ink-200 px-5 py-4">
          ...
          <p className="mt-1 text-sm text-ink-500">
            ...
            endpoint agent, browser AI protection, and this organization’s
            enrollment secrets. Employees install once — AI traffic is
            protected automatically, and agents register only to your workspace.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3 text-sm text-ink-600">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-ink-500">
                ...
                download includes the guided installer and agent binary.
              </p>
            </div>
          </div>
          <button
      ...
      <div className="rounded-lg border border-ink-200 bg-white px-5 py-4 text-sm text-ink-600">
        ...
        <ol className="mt-2 list-decimal space-y-1 pl-5">
          ...
          <li>
            ...
            their password once — install is automatic and protection starts
            for AI apps and browser sessions.
          </li>
          <li>
            After install, quit and reopen browsers so the new trust settings
            take effect. The device appears Online under{" "}
