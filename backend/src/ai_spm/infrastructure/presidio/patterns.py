"""Shared PII mask formats + regex recognizers (gateway + web MITM parity).

Patterns for previously \"catalog only\" entities use labeled / contextual
forms where free-form matching would be too aggressive (e.g. gender words).
"""
